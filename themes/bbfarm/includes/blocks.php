...
function blocks_scripts() {
	...
	wp_enqueue_script(
		'blocks',
		BBFARM_TEMPLATE_URL . '/dist/js/blocks.js',
		[],
		BBFARM_VERSION,
		true
	);
...
function blocks_editor_scripts() {
	...
	wp_enqueue_script(
		'blocks-editor',
		BBFARM_TEMPLATE_URL . '/dist/js/blocks-editor.js',
	...
	wp_enqueue_style(
		'editor-style',
		BBFARM_TEMPLATE_URL . '/dist/css/editor-style.css',
		[],
		BBFARM_VERSION
	);
